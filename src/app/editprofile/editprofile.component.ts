...
export class EditprofileComponent implements OnInit {
    ...
    this.httpclient
      ...
      .subscribe((res: any) => {
        ...
        if (this.response.success == true) {
          ...
          if (this.logo_images != null) {
            this.image =
              "https://gbosss.com/assets/images/gallery/" + this.logo_images;
          } else {
            this.image = "assets/images/demo.jpg";
          }
        } else if (this.response.success == false) {
  ...
  qrcodeupdate() {
    this.httpclient
      ...
      .subscribe((res: any) => {
        ...
        if (this.response.success == true) {
          // const url = `https://gbosss.com/order-bharat-qr.php?user_id=${this.user_id}&company_id=${this.company_id}`;
  ...
  async onSubmit() {
    ...
    if (this.selectedFile) {
      ...
      this.httpclient
        .post(environment.apiBaseUrl + "uploadLogoFile", formData, {
          reportProgress: true,
          observe: "events",
        })
        .subscribe(
  ...
  updateFileuploaddata() {
    ...
    this.httpclient
      ...
      .subscribe((res: any) => {
        this.response = res;
        console.log("upload file:::::", res.body);
