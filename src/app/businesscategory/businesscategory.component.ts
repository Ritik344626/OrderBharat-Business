...
@Component({
  ...
  styleUrls: ['./businesscategory.component.scss'],
})
export class BusinesscategoryComponent implements OnInit {
  ...
  user_id: any;
  company_id: any;
  mobile_business_category: any='Kirana';
  ...
  submitquery() {
    ...
    this.httpclient
      .post(environment.apiBaseUrl + 'editbusinesscategory', [
        {
          api_key: environment.apikey,
          user_id: this.user_id,
          // company_id: this.company_id,       
          mobile_business_category: this.mobile_business_category,
        },
      ])
      .subscribe((res: any) => {
        this.response = res;
